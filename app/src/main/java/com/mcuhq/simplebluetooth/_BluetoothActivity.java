...
public class _BluetoothActivity extends AppCompatActivity{
  ...
  //private void scheduleRxMessage(String msg){
     //   if(msg.contains(TYPE_IBOX)) {
       //     Log.d("TYPE_IBOX", "entrando a ibox");
